...
ANOMALY_DETECTOR_ENDPOINT = "https://anomaly-new.cognitiveservices.azure.com/"
SUBSCRIPTION_KEY = "45a5d2b0eba548aa95eaaa25b09c6292"

ad_client = AnomalyDetectorClient(ANOMALY_DETECTOR_ENDPOINT, AzureKeyCredential(SUBSCRIPTION_KEY))

time_format = "%Y-%m-%dT%H:%M:%SZ"
blob_url = "https://elg5164.blob.core.windows.net/elg5164/insurance-edited.csv"  # example path: https://docstest001.blob.core.windows.net/test/sample_data_5_3000.csv
